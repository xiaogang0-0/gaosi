...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        showZoom: true,
        showDrag: true,
        removeIcon: '<i class="fa fa-times-circle text-danger"></i>',
        removeClass: 'btn btn-xs btn-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="fa fa-arrow-circle-up text-info"></i>',
    ...
    tFileIcon = '<i class="fa fa-file-text-o kv-caption-icon"></i> &nbsp;';
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-primary btn-warning ',
